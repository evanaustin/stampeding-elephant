 ...
 */
registerBlockType( 'lu/block-accordion', {
	...
	edit: ( props ) => {
		...
		return (
			<div className={ props.className }>
				...
				<p>
					CGB ACCORDION BLOCK: <code>accordion</code> is a new Gutenberg block
				</p>
				<p>
					It was created via{ ' ' }
					<code>
	...
	save: ( props ) => {
		return (
			<div className={ props.className }>
				...
				<p>
					CGB BLOCK: <code>accordion</code> is a new Gutenberg block.
				</p>
				<p>
					It was created via{ ' ' }
					<code>
